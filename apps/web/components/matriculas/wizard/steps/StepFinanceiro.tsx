  ...
  return (
    <div className="space-y-4">
      <div className="grid grid-cols-2 gap-4 text-xs">
        ...
        <div className="flex flex-col gap-1.5 col-span-2">
          ...
          <Select
            ...
            onValueChange={(v) =>
              update({ formaPagamento: v as 'DINHEIRO' | 'PIX' | 'CARTAO' | 'BOLETO' })
            }
          >
            <SelectTrigger>
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <div className="flex gap-2">
            <Select
              value={localDescontoTipo}
              onValueChange={(v) => setLocalDescontoTipo(v as 'FIXO' | 'PERCENTUAL')}
            >
      ...
      <div className="rounded border p-3 bg-gray-50 text-xs space-y-1">
        <p>
          <span className="font-medium">Plano base:</span> R$ {planoValor.toFixed(2)}
        </p>
        <p>
          <span className="font-medium">Desconto aplicado:</span> R$ {descontoAplicado.toFixed(2)}
        </p>
        <p>
          <span className="font-medium">Mensalidade final:</span> R$ {valorFinal.toFixed(2)}
        </p>
      </div>
