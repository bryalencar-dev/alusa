// Centralização de variants (design tokens + cva) para componentes reutilizáveis.
// Objetivo: padronizar estados, tamanhos e cores sem duplicar classes Tailwind.
// Mantemos dependência mínima (class-variance-authority + tailwind-merge via util cn).
...
// Helper para compor classes de input
