/**
 * API Route: Dados de Checkout PIX
 *
 * GET /api/checkout/pix/[cobrancaId]
 *
 * Retorna dados da cobrança e payment PIX para exibição do QR Code
 */
...
export async function GET(
  ...
  try {
    ...
    console.error('[API GET /checkout/pix/:id] Erro:', error);
