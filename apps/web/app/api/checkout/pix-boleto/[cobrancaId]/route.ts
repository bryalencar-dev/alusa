/**
 * API Route: Dados de Checkout PIX/Boleto
 *
 * GET /api/checkout/pix-boleto/[cobrancaId]
 *
 * Retorna dados da cobrança com payment PIX/Boleto (ambos disponíveis)
 */
...
export async function GET(
  ...
  try {
    ...
    // 2. Buscar dados do payment no Asaas (inclui PIX QR Code e Boleto URL)
    ...
    console.error('[API GET /checkout/pix-boleto/:id] Erro:', error);
